...
class Snake:
	...
	func initialize(start_pos: Vector2) -> void:
		...
		var head = SnakeSegment.new("head", preload("res://assets/larve/LarveHead1.png"))
		var body = SnakeSegment.new("body", preload("res://assets/larve/LarveBody1.png"))
		var tail = SnakeSegment.new("tail", preload("res://assets/larve/LarveButt1.png"))
	...
	func grow() -> void:
		...
		old_tail.sprite.texture = preload("res://assets/larve/LarveBody1.png")
		old_tail.segment_type = "body"
		
		# Create new tail
		var new_tail = SnakeSegment.new("tail", preload("res://assets/larve/LarveButt1.png"))
